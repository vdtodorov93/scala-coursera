...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__sci_Set__D = (function(expr, references, met) {
  if ($is_Lcalculator_Literal(expr)) {
    ...
    var name = x3.name$2;
    return (met.contains__O__Z(name) ? (NaN) : this.eval__Lcalculator_Expr__sci_Map__D(this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references), references))
  } else if ($is_Lcalculator_Plus(expr)) {
    var x4 = $as_Lcalculator_Plus(expr);
    var a = x4.a$2;
    var b = x4.b$2;
    return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a, references, met) + this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b, references, met))
  } else if ($is_Lcalculator_Minus(expr)) {
    var x5 = $as_Lcalculator_Minus(expr);
    var a$2 = x5.a$2;
    var b$2 = x5.b$2;
    return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a$2, references, met) - this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b$2, references, met))
  } else if ($is_Lcalculator_Times(expr)) {
    var x6 = $as_Lcalculator_Times(expr);
    var a$3 = x6.a$2;
    var b$3 = x6.b$2;
    return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a$3, references, met) * this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b$3, references, met))
  } else if ($is_Lcalculator_Divide(expr)) {
    var x7 = $as_Lcalculator_Divide(expr);
    var a$4 = x7.a$2;
    var b$4 = x7.b$2;
    return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a$4, references, met) / this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b$4, references, met))
  } else {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().comp__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set(a$2, b$2, c$2, delta$1)
    })
  })(a, b, c, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.comp__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set = (function(a, b, c, delta) {
  if (($uD(delta.apply__O()) < 0)) {
    ...
    var array = [((-$uD(b.apply__O())) / (2 * $uD(a.apply__O())))];
    ...
    var jsx$5 = $uD(b.apply__O());
    var a$1 = $uD(delta.apply__O());
    var jsx$4 = $uD($g.Math.sqrt(a$1));
    var jsx$3 = $uD(a.apply__O());
    var jsx$2 = $uD(b.apply__O());
    var a$2 = $uD(delta.apply__O());
    var array$1 = [(((-jsx$5) - jsx$4) / (2 * jsx$3)), (((-jsx$2) + $uD($g.Math.sqrt(a$2))) / (2 * $uD(a.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$color__I__T = (function(remaining) {
  return ((remaining < 0) ? "red" : ((remaining < 15) ? "orange" : "green"))
});
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$color__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Var().init___F0(expr)
});
  ...
  if ((x0$1 !== null)) {
    ...
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, key$1, value$1) {
      return (function() {
        ...
        var jsx$3 = $as_Lcalculator_Expr(value$1.apply__O());
